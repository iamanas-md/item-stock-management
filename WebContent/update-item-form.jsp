...
<tr>
<td> Unit :</td>
<td><input type="text" name="unit" value="${ITEM.unit }" required = "required" placeholder="Eg- ml,mg,pcs"></td>
</tr>
<tr>
<td> Beginning Inventory :</td>
<td><input type="number" name="beginningInventory" value="${ITEM.beginningInventory }" required = "required" placeholder="Enter Number"></td>
</tr>

<tr>
<td> Quantity On Hand : </td>
<td> <input type="number" name="quantityOnHand" value="${ITEM.quantityOnHand }" required = "required" placeholder="Enter Number" > </td>
</tr>
<tr>
<td> Price Per Unit : </td>
<td> <input type="number" name="pricePerUnit" value="${ITEM.pricePerUnit }" required="required" placeholder="Enter Price" min="0"> </td>
</tr>
<tr>
<td> Date of Manufacture :</td>
<td><input type="date" name="dateOfManufacture" value="${ITEM.dateOfManufacture }" required = "required"></td>
</tr>
<tr>
...
<tr>
<td><label></label></td>
<td><button type="submit" class="btn btn-primary btn-lg">Update Item</button></td>
</tr>
</tbody>
</table>
</form>
