...
<header id="main-header" class="py-2 bg-warning text-white">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
         <img src="images/a.jpg" height="100" width="100"  class="rounded float-left" alt="Anas"> <h1>Item Stock Management</h1>
        </div>
      </div>
    </div>
  </header>
...
<td colspan="2"> </br> <button type="submit" class="btn btn-primary">Sign Up</button>  </td>
